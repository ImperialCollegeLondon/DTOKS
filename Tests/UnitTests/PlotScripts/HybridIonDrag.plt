...
set output sprintf("Tests/UnitTests/Plots/HybridIonDrag_UTeTi.eps",prefix)
set logscale x
set logscale y
set logscale z
set format z "%s*10^{%S}"
...
set output sprintf("Tests/UnitTests/Plots/HybridIonDrag_TeTiPhi.eps",prefix)
#set logscale x
#unset logscale y
#set xlabel('Temperature Ratio Te/Ti')
#set ylabel('Normalised potential (arb)')
#set zlabel('Ion Drag Force (N)')
#splot filename using 2:3:4
