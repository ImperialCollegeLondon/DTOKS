...
int ConstantGravityTest(char Element){
	clock_t begin = clock();
	// ********************************************************** //
...
//	Pdata->PlasmaVel = PlasmaVelocity;
	...
	ForceModel MyModel("Tests/IntegrationTests/Data/out_ConstantGravityTest.txt",1.0,ForceModels,Sample,Pdata);
	...
	threevector AnalyticVelocity = (Pdata->Gravity)*(imax*MyModel.get_timestep());
